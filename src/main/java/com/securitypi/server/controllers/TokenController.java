...
public class TokenController {
	...
	@RequestMapping(value = "/revoke/{token}", method = {RequestMethod.POST}, produces = {"application/json"})
	public ResponseEntity<String> revokeToken(@PathVariable String token) {
